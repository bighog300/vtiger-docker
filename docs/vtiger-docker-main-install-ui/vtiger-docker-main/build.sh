...
DEFAULT_LOCAL_IMAGE="vtigercrm-local"
DEFAULT_REGISTRY_IMAGE="ghcr.io/${GITHUB_REPOSITORY_OWNER:-bighog300}/vtigercrm"
IMAGE="${IMAGE:-$( [ "$NO_PUSH" = true ] && printf "%s" "$DEFAULT_LOCAL_IMAGE" || printf "%s" "$DEFAULT_REGISTRY_IMAGE" )}"
